...
for base_dir in base_dirs:
    # Criar um index.html na própria pasta base
    ...
    # Criar/atualizar o index.html na pasta base
    with open(os.path.join(base_dir, "index.html"), "w", encoding="utf-8") as f:
        f.write(index_html_content)

print("Arquivos index.html das pastas principais foram criados com sucesso! 🎉")
